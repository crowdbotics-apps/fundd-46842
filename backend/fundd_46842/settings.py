"""
Django settings for fundd_46842 project.
...
WSGI_APPLICATION = 'fundd_46842.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fundd_46842 API",
    "DESCRIPTION": "API documentation for fundd_46842 App",
    "VERSION": "v1",
}
